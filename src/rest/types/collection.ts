...
export type Conditions<C extends CollectionNames> = CollectionMap[C]['conditions'];
...
export type PartialPaths<C extends CollectionNames> = CollectionMap[C]['partialPaths'];

export type Resolvables<C extends CollectionNames> = CollectionMap[C] extends { resolve: infer R } ? R : never;
