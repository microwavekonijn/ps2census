...
export type Collections = Ability | AbilityType | ArmorInfo | Character | CharacterName | CharactersAchievement | Achievement | CharactersCurrency | ArmorFacing | CharactersDirectiveTree | CharactersEvent | CharactersFriend | CharactersItem | CharactersLeaderboard | CharactersEventGrouped | CharactersOnlineStatus | CharactersSkill | CharactersStat | CharactersStatByFaction | CharactersDirective | CharactersWeaponStat | CharactersWeaponStatByFaction | Currency | Directive | DirectiveTier | DirectiveTreeCategory | CharactersWorld | DirectiveTree | Effect | EffectType | Event | EmpireScores | Experience | FacilityLink | FacilityType | CharactersDirectiveObjective | FireGroup | CharactersDirectiveTier | FireMode2 | FireModeToProjectile | CharactersStatHistory | FireMode | Image | ImageSet | ImageSetDefault | FireModeType | ItemCategory | Item | ItemProfile | ItemAttachment | ItemToWeapon | Map | MapHex | MapRegion | MarketingBundle | MarketingBundleItem | ItemType | MarketingBundleWith1Item | MetagameEvent | Loadout | Leaderboard | Objective | ObjectiveSetToObjective | OutfitMember | ObjectiveType | Outfit | OutfitRank | PlayerState | MetagameEventState | OutfitMemberExtended | Profile2 | ProfileArmorMap | ProfileResistMap | Projectile | ProjectileFlightType | Region | ResistInfo | Profile | PlayerStateGroup | ResistType | ResourceType | Reward | RewardType | RewardGroupToReward | PlayerStateGroup2 | Skill | SkillCategory | SkillLine | RewardSetToRewardGroup | SkillSet | Title | Vehicle | VehicleAttachment | VehicleFaction | VehicleSkillSet | Weapon | WeaponAmmoSlot | ExperienceRank | SingleCharacterById | WeaponToAttachment | WeaponDatasheet | WorldEvent | World | Zone | TargetType | ZoneEffectType | Faction | ZoneEffect | WorldStatHistory | FireGroupToFireMode | WeaponToFireGroup;